<template>
    <nav class="navbar centred" role="navigation">
        <ul class="nav-buttons centred">
            <nav-item v-for="page in pages" :ref="page.name" :icon="page.icon" :page="page.name"
                      :tooltip="page.tooltip"></nav-item>
        </ul>
        ...
        <ul class="help-buttons centred">
            ...
            <help-item icon="logout" page="/" tooltip="Sign out and return to the main menu."></help-item>
        </ul>
    </nav>
</template>
